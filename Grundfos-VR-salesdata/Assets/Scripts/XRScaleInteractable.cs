    ...
    public class XRScaleInteractable : XRBaseInteractable
    {
        ...
        protected override void OnSelectExit(XRBaseInteractor interactor)
        {
            ...
            if (m_FirstSelectingInteractor == interactor)
            {
                ...
                GetComponentInChildren<DeletePlotController>().endDeletion();
            }
        }
        ...
        void Update()
        {
            ...
            if (m_FirstSelectingInteractor && !m_SecondSelectingInteractor)
            {
                ...
                if (!initialGrab.isInitialised)
                {
                    ...
                    //find DeletePlotController on interactable and reset its deletion
                    DeletePlotController deleteReference = GetComponentInChildren<DeletePlotController>();
                    deleteReference.beginDeletion();
                    deleteReference.resetDeletion(m_FirstSelectingInteractor.transform.position);
                    deleteReference.transform.position = m_FirstSelectingInteractor.transform.position + new Vector3(0f, 0f, (0 - deleteReference.threshold) / 4);
                    deleteReference.beginDeletion();
                }
